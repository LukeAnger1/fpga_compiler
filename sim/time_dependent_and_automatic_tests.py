#!/usr/bin/env python3
# [treesource] This script tests pipelines
...
def runner():
    ...
    sources = [
        proj_path / "hdl" / "tests_dont_use" / "test_eventual_answer.v"
    ]  # grow/modify this as needed.
    hdl_toplevel = "test_eventual_answer"
...
def compile_pipeline_time_dep_and_auto():
    module = MigenPipelineCompiler("test_eventual_answer")
    a = Var(module, VarType(TEST_BIT_SIZE, False, True, True, False, True), name="a")
    b = Var(module, VarType(TEST_BIT_SIZE, False, True, True, False, True), name="b")
    c = a + b
    d = a - b
    e = a * b
    f = c | d
...
if __name__ == "__main__":
    compile_pipeline_time_dep_and_auto()
    runner()
